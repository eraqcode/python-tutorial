...
def ventana_emergente():
    messagebox.showinfo('CodeRaq', "Tu procesador de codigo favorito")
...
opcion_archivo.add_command(label = 'Salir', command = cerrar_ventana)
...
opcion_ayuda.add_command(label = 'Acerca De', command = ventana_emergente)
